...
_lr_productions = [
  ...
  ('expression -> NUMBER','expression',1,'p_expression','compile.py',72),
  ('expression -> expression OPTASU expression','expression',3,'p_expression','compile.py',73),
  ('expression -> expression OPHIKU expression','expression',3,'p_expression','compile.py',74),
  ('expression -> expression OPKAKE expression','expression',3,'p_expression','compile.py',75),
  ('expression -> expression OPWARU expression','expression',3,'p_expression','compile.py',76),
  ('expression -> SYMBOL','expression',1,'p_expression_var','compile.py',87),
]
