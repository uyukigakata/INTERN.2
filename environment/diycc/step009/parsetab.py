...
_lr_productions = [
  ...
  ('kansuuteigi -> TYPE SYMBOL KAKKO KOKKA LBRACE bunlist RBRACE','kansuuteigi',7,'p_kansuuteigi','compile.py',25),
  ...
  ('bun -> TYPE SYMBOL SEMI','bun',3,'p_bun_sengen','compile.py',49),
  ('expression -> NUMBER','expression',1,'p_expression','compile.py',55),
  ('expression -> expression OPTASU expression','expression',3,'p_expression','compile.py',56),
  ('expression -> expression OPHIKU expression','expression',3,'p_expression','compile.py',57),
  ('expression -> expression OPKAKE expression','expression',3,'p_expression','compile.py',58),
]
